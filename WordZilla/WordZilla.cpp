...
// WordZilla.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWordZillaApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CWordZillaApp::OnAppAbout)
...
// создание CWordZillaApp

CWordZillaApp::CWordZillaApp()
{
	...
	SetAppID(_T("WordZilla.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CWordZillaApp

CWordZillaApp theApp;


// инициализация CWordZillaApp

BOOL CWordZillaApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_WordZillaTYPE,
		RUNTIME_CLASS(CWordZillaDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CWordZillaView));
	if (!pDocTemplate)
		return FALSE;
	pDocTemplate->SetContainerInfo(IDR_WordZillaTYPE_CNTR_IP);
...
int CWordZillaApp::ExitInstance()
{
...
// обработчики сообщений CWordZillaApp
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_UPDATE_COMMAND_UI(ID_CHAR_BOLD, &CAboutDlg::OnUpdateCharBold)
END_MESSAGE_MAP()

// Команда приложения для запуска диалога
void CWordZillaApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CWordZillaApp настройка методов загрузки и сохранения

void CWordZillaApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CWordZillaApp::LoadCustomState()
{
}

void CWordZillaApp::SaveCustomState()
{
}
...
void CAboutDlg::OnUpdateCharBold(CCmdUI *pCmdUI)
{
